...
A sample application for managing Music Albums, done with Electron, Angular2, Angular material
...
`git clone https://github.com/iltizio/music_library.git`
...
This Application utilizes a few packages to ensure an automated and easy to use workflow with Angular 2. Here is a list of them and their purposes: 
